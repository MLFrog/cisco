                ...
                <div id="content">
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 className="h3 mb-0 text-gray-800">Ecotricity parking space</h1>
                            <a href="#" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                className="fas fa-download fa-sm text-white-50"/> Generate Report</a>
                        </div>

                        {/* Card Content Row // div className=row 로 감싸줘야 함.*/}
                        <div className="row">
                            <CardContent/>
                        </div>

                        {/* Chart Content Row // div className=row 로 감싸줘야 함.*/}
                        <div className="row">
                            <ChartContent/>
                            <ProgressContent/>
                        </div>
                        ...
                        {/* Content Row // div className=row 로 감싸줘야 함.*/}
                        <div className="row">
